...
if (isset($_POST['add'])) {
    ...
    $set = "INSERT INTO imp(name,des,time,date,uid) VALUE('$name','$des','$DBtime','$date','$uid')";
    $query = mysqli_query($conn, $set);
}
if (isset($_GET['del'])) {
    $id = $_GET['del'];
    $del = "DELETE FROM imp WHERE id = '$id'";
...
$user = mysqli_fetch_assoc($se);


$select = "SELECT * FROM imp where uid = '$uid'";
        ...
        <div class="col-2">
            <div class="text-white bg-dark" style="width: 30vh;height: 100vh; position:fixed;">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="important.php" class="nav-link text-white active">
                            Important
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="card w-100 mt-5">
                        <div class="card-body">
                            <div class="row align-items-center d-flex justify-content-center">
                                <a href="add3.php"><i class="fa-solid fa-plus fa-5x"></i></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card w-100 mt-5">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <h1 class="card-text ml-5"><?php echo $row['time'] ?><br><?php echo $row['date'] ?></h1>
                                    <h1 class="card-text col-sm ml-5"><?php echo $row['name'] ?><br>
                                        <small style="font-size:16px;"><?php echo $row['des'] ?>
                                        </small>
                                    </h1>
                                    <a href="important.php?del=<?php echo $row['id']; ?>" class="mr-4"><i class="fa fa-check-circle fa-8x" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
